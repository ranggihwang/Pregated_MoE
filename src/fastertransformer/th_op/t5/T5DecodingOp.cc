    ...
    _weights(w)
{
    ...
    if (ft::GlobalConfig::instance().load_from_cpp) {
        ...
        auto fetcher_mode = ft::GlobalConfig::instance().decoder_fetcher_mode;
                    ...
                    if (disk_offload) {
                        ...
                        for (int e = 0; e < expert_num; e++) {
                            wi_filenames.push_back(
                                offload_path + "decoder.block." + std::to_string(i) + ".layer.2.mlp.experts.expert_" + std::to_string(e) + ".wi.weight.0.bin");
                            wo_filenames.push_back(
                                offload_path + "decoder.block." + std::to_string(i) + ".layer.2.mlp.experts.expert_" + std::to_string(e) + ".wo.weight.0.bin");
                        }
                        _weights.push_back(
